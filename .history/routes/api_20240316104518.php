...
Route::prefix('v1')->group(function () {
    ...
    Route::prefix('usuarios')->group(function () {
        ...
        Route::get('/usuarios', [UsuariosClienteController::class, 'index']);
        Route::post('/usuarios/login', [UsuariosClienteController::class, 'login']);
        Route::post('/usuarios', [UsuariosClienteController::class, 'store']);
        Route::get('/usuarios/{id}', [UsuariosClienteController::class, 'show']);
        Route::put('/usuarios/{id}', [UsuariosClienteController::class, 'update']);
        Route::delete('/usuarios/{id}', [UsuariosClienteController::class, 'destroy']);
    });
