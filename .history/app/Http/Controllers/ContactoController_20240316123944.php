...
class ContactoController extends Controller
{
    public function store(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'usuarios_clientes_id' => 'required|exists:usuariosClientes,id'
        ]);
        ...
        try {
            // Crear el contacto
            $contacto = Contacto::create($request->only('comentario'));

            // Crear el detalle del contacto
            $detalle = new ContactoClientesDetalle([
                'usuarios_clientes_id' => $request->usuarios_clientes_id
            ]);
            $contacto->detalles()->save($detalle);
